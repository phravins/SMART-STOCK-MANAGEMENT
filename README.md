...
5. Add Environment Variables (click "Add Environment Variable"):
   ...
   - `DB_NAME` = `smartstock`
   - `TWILIO_ACCOUNT_SID` = `ACf3cb7a768e1f5fd12ce9de4ea7357cf4`
   - `TWILIO_AUTH_TOKEN` = `3b1fcec7154776066acfd100a9f39cf6`
   - `TWILIO_WHATSAPP_FROM` = `whatsapp:+14155238886`
   - `TWILIO_WHATSAPP_TO` = `whatsapp:+919543573515`
   - `MAIL_SERVER` = `smtp.gmail.com`
   - `MAIL_PORT` = `587`
   - `MAIL_USE_TLS` = `True`
   - `MAIL_USERNAME` = `phravin.v2v@gmail.com`
   - `MAIL_PASSWORD` = `ntpo nzjy phlh zpkk`
   - `MAIL_DEFAULT_SENDER` = `phravin.v2v@gmail.com`
   - `ALERT_EMAIL_TO` = `phravin.v2v@gmail.com`
6. Click "Create Web Service"
7. Copy the backend URL (e.g., `https://smartstock-api.onrender.com`)
...
Access interactive API docs at: `https://your-backend-url.onrender.com/docs`
